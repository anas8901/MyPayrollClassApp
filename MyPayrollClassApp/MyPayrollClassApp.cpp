#include "Payroll.h" //#include "Payroll.h": Includes the header file Payroll.h, which contains the declaration of the Payroll class. This allows us to use the Payroll class in this file.
